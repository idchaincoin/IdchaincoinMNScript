#!/bin/bash
# IDCHAINCOIN Masternode Setup Script v1.2.0 for Ubuntu LTS
#
...
wget https://github.com/idchaincoin/idchaincoin/releases/download/v1.2.0/idchaincoin-1.2.0-ubuntu-daemon-18.04.tar.gz
tar -xzvf idchaincoin-1.2.0-ubuntu-daemon-18.04.tar.gz
...
cd ~/.idchaincoin && wget https://github.com/idchaincoin/idchaincoin/releases/download/v1.2.0/bootstrap.zip
